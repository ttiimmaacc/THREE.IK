...
var IKJoint = function (_Object3D) {
  ...
  function IKJoint(bone) {
    ...
    _this.bone = bone;
    _this.distance = 0;
    _this._originalDirection = new three.Vector3();
    _this._direction = new three.Vector3();
    _this._worldPosition = new three.Vector3();
    _this._isSubBase = false;
    _this._subBasePositions = null;
    _this.isIKJoint = true;
    _this._tempQuaternion = new three.Quaternion();
  ...
  createClass(IKJoint, [{
    ...
    value: function _applyWorldPosition() {
      ...
      if (parent) {
        ...
        var inverseParent = new three.Matrix4().copy(parent.matrixWorld).invert();
